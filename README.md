...
- **`3-Hands-on.md`** — Your practice file for the live session. Walks you through your first Git workflow (edit, commit, push) using `sample.html`, plus a "Try It Yourself" exercise comparing Chat, Claude Code in the terminal, and Claude Code in the sidebar.
...
- **`sample.html`** — A simple sample file used in `3-Hands-on.md` for practicing edits, saving, and viewing changes in the browser.
...
- Complete a hands-on Git workflow exercise with `sample.html` and build confidence with the editor.
- Compare AI coding assistants (Chat, Claude Code terminal, Claude Code sidebar) using the same prompt — both watched live and tried yourself.

## How to Use These Materials

1. **Before the workshop:** Follow `1-Installing-vscode.md` to install VS Code, then review the "Before You Start" section in the workshop guide.

2. **During the workshop:** Open `2-Build-together-vscode-workshop.md` and follow along step by step. Use `3-Hands-on.md` for your practice exercises. We'll build confidence together.

3. **After the workshop:** Use `4-Vscode-101-final.md` as your reference guide. Come back to it whenever you need clarification or want to explore a feature in more depth.

4. **Have questions?** Check `5-Office-hours-follow-up.md` — your question might already be answered there!
...
- Need to install VS Code first? → Read `1-Installing-vscode.md`
- Need to get started? → Read `2-Build-together-vscode-workshop.md`
- Ready to practice? → Open `3-Hands-on.md`
- Looking for answers? → Check `4-Vscode-101-final.md`
- Have specific questions? → See `5-Office-hours-follow-up.md`
